...
RUN mkdir -p "$GOPATH/src" "$GOPATH/bin" && chmod -R 777 "$GOPATH" && aria2c https://dl.dropboxusercontent.com/s/xghoto9xxt53keb/accounts.zip && 7z x accounts.zip && rm accounts.zip
